...
public class RefinedShapedRecipe implements IRecipe {
	...
	public RefinedShapedRecipe(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack) {
	...
	public RefinedShapedRecipe func_92100_c() {
