...
public class RenderCrystalChest extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderEnderChest(TileEntityCrystalChest chest, double par2, double par4, double par6, float par8)
    {
        int i = 0;
        ...
        GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
        float f1 = chest.prevLidAngle + (chest.lidAngle - chest.prevLidAngle) * par8;
        f1 = 1.0F - f1;
        f1 = 1.0F - f1 * f1 * f1;
    ...
    {
        this.renderEnderChest((TileEntityCrystalChest)par1TileEntity, par2, par4, par6, par8);
    }
}
