...
public class GuiCrystalChest extends GuiContainer {
	...
	public GuiCrystalChest(IInventory par1IInventory, IInventory par2IInventory) {
		super(new ContainerCrystalChest(par1IInventory, par2IInventory));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRenderer.drawString(StatCollector
				.translateToLocal(this.lowerChestInventory.getInvName()), 8, 6,
				4210752);
		this.fontRenderer.drawString(StatCollector
				.translateToLocal(this.upperChestInventory.getInvName()), 8,
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		this.drawTexturedModalRect(var5, var6, 0, 0, this.xSize,
