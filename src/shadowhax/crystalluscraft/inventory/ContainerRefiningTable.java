package shadowhax.crystalluscraft.inventory;
...
public class ContainerRefiningTable extends Container {
	...
	public ContainerRefiningTable(InventoryPlayer inventoryplayer, World world, int i, int j, int k) {
         ...
         for(int l = 0; l < 5; l++) {
             ...
             for(int k1 = 0; k1 < 5; k1++) {
                 ...
                 this.addSlotToContainer(new Slot(craftMatrix, k1 + l * 5, 1 + k1 * 18, -1 + l * 18));
             }
         }
	...
	public boolean canInteractWith(EntityPlayer entityplayer) {
		...
		if (worldObj.getBlockId(posX, posY, posZ) != Blocks.refiningTable.blockID) {
